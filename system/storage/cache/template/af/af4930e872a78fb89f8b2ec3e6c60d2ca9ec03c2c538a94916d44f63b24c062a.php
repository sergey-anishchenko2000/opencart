...
class __TwigTemplate_65a436765a3bc890816c4fdbecee95e4c1ec07751e3704656abffee50205c97a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div id=\"content\">
    ...
    <div class=\"container-fluid\">
        ...
        echo "                        </div>
                    ...
                    <div class=\"form-group required\">
                        <label class=\"col-sm-2 control-label\" for=\"input-range\">";
        // line 45
        ...
        echo "</label>
                        <div class=\"col-sm-10\">
                            <input type=\"text\" name=\"module_price_slider_range\"
                                   value=\"";
        // line 48
        echo ($context["module_price_slider_status"] ?? null);
        echo "\"
                                   placeholder=\"";
        // line 49
        echo ($context["entry_price_range"] ?? null);
        echo "\" id=\"price_slider_range\" class=\"form-control\"
                            ...
                            ";
        // line 51
        if (($context["error_ps_range"] ?? null)) {
            // line 52
            echo "                                <div class=\"text-danger\">";
            echo ($context["error_ps_range"] ?? null);
            echo "</div>
                            ";
        }
        // line 54
