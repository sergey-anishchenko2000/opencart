    ...
    public function index()
    {
        ...
        if(isset($this->request->get['article_id'])){
            ...
            if(!empty($data['author'])){
                ...
                $data['author']['href'] =  $this->url->link('news/news', 'author=' . $article_info['author_id']);
            }               
            // Comments
            ...
            if(!empty($results)){
                foreach ($results as $article_id) {
                    ...
                    $data['articles'][] = array(
                        ...
                        'tags' => $tags_array,
                        'thumb'     => $thumb,
                        'href'        => $this->url->link('news/detail', (isset($this->request->get['path']) ? 'path=' . $this->request->get['path'] . '&' : '') .'article_id=' . $result['article_id'])
                    );
                }
            }
                ...
                foreach ($parts as $path_id) {
                    ...
                    if ($category_info) {
                        $data['breadcrumbs'][] = array(
                            ...
                            'href' => $this->url->link('news/news', 'path=' . $path_new . $url)
                        );
                    }
                }
            ...
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('news/detail', 'article_id=' . $article_info['article_id'])
            );
           ...
           $this->response->setOutput($this->load->view('news/article_detail/' . str_replace('.tpl', '', $this->settings['article_detail_template']), $data));
