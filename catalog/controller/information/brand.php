<?php
class ControllerInformationBrand extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('information/brand');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('information/brand/success'));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('information/brand')
		);
		...
		$data['action'] = $this->url->link('information/brand', '', true);
		...
		// Captcha
		if ($this->config->get('captcha_' . $this->config->get('config_captcha') . '_status') && in_array('brand', (array)$this->config->get('config_captcha_page'))) {
