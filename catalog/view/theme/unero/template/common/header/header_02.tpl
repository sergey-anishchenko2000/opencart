...
<div class="canvas-setting type2">
...
<!-- HEADER
	================================================== -->
<header class="header-type-1 header-type-2">
					...
					<div class="container">	
						<div style="position: relative">
							<div class="row">
								...
								<!-- Header Right -->
								<div class="col-lg-10 col-md-3 col-sm-3 col-xs-3" id="header-right">
									...
									<a class="menu-sidebar" id="icon-menu-sidebar" href="#"><span><?php if($theme_options->get( 'menu_text', $config->get( 'config_language_id' ) ) != '') { echo html_entity_decode($theme_options->get( 'menu_text', $config->get( 'config_language_id' ) )); } else { echo 'Menu'; } ?></span><i class="t-icon icon-menu"></i></a>
								</div>
							</div>
						</div>
					</div>
