...
<head>
    ...
    $lista_plikow[] = 'catalog/view/theme/'.$config->get('theme_' . $config->get('config_theme') . '_directory').'/js/scrollreveal.min.js';
...
<body class="<?php echo $klasa; ?> <?php echo $theme_options->get( 'body_custom_class' ); ?> <?php $breadcrumb = $modules->getModules('breadcrumb'); if( count($breadcrumb) ) { echo 'body-with-breadcrumb'; } ?>">
