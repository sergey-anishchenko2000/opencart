...
class ModelCSRArticle extends Model {
	...
	public function getArticle($article_id) {
		$query = $this->db->query("SELECT *
                ...
                LEFT JOIN " . DB_PREFIX . "CSR_article_to_store ba2s ON (ba.article_id = ba2s.article_id)
	...
	public function getArticleCategories($article_id) {
        ...
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "CSR_article_to_category batc
                LEFT JOIN " . DB_PREFIX . "CSR_category bc ON bc.category_id = batc.category_id
                LEFT JOIN " . DB_PREFIX . "CSR_category_description bcd ON bcd.category_id = bc.category_id
                LEFT JOIN " . DB_PREFIX . "CSR_category_to_store bc2s ON (bc.category_id = bc2s.category_id)
    ...
    public function getProductRelated($article_id, $limit = null) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "CSR_product_related WHERE article_id = '" . (int)$article_id . "'" . ($limit ? " LIMIT " . (int)$limit : ''));
    ...
    public function getArticleRelated($article_id, $limit = null) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "CSR_article_related WHERE article_id = '" . (int)$article_id . "'" . ($limit ? " LIMIT " . (int)$limit : ''));
    ...
    public function getArticleToProductRelated($product_id, $limit = null) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "CSR_product_related WHERE related_id = '" . (int)$product_id . "'" . ($limit ? " LIMIT " . (int)$limit : ''));
    ...
    public function getArticleAuthor($article_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "CSR_article_author
                 WHERE article_id = '" . (int)$article_id . "' ORDER BY sort_order ASC");
	...
	public function getArticles($data = array()) {
		$sql = "SELECT *, ba.article_id FROM " . DB_PREFIX . "CSR_article ba
                LEFT JOIN " . DB_PREFIX . "CSR_article_description bad ON (ba.article_id = bad.article_id)
                LEFT JOIN " . DB_PREFIX . "CSR_article_to_category bctc ON bctc.article_id = ba.article_id
                LEFT JOIN " . DB_PREFIX . "CSR_article_to_store ba2s ON (ba.article_id = ba2s.article_id)
	...
	public function getPopularArticles($limit) {
		$sql = "SELECT *, ba.article_id FROM " . DB_PREFIX . "CSR_article ba
                ...
                ORDER BY (SELECT count(*) FROM " . DB_PREFIX . "CSR_comment bc WHERE bc.article_id = ba.article_id) DESC, ba.date_published  DESC
                LIMIT " . (int)$limit . "
                ";
	...
	public function getPopularTags() {
		...
		$query = $this->db->query("SELECT tags FROM " . DB_PREFIX . "CSR_article_description WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'");
