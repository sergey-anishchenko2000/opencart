...
<a href="#">Bag</a>, <a href="#">Backpack</a>, <a href="#">Chair</a>, <a href="#">Clock</a>, <a href="#">Interior</a>, <a href="#">Indoor</a>, <a href="#">Gift</a>, <a href="#">Accessories</a>, <a href="#">Fashion</a>, <a href="#">Simple</a>
  ...
  array (
	...
	<div class="home-banners clearfix">
		<div class="big"><a href="#"><img src="image/catalog/modern/banner-01.jpg" alt=""></a></div>
		<div class="small"><a href="#"><img src="image/catalog/modern/banner-02.jpg" alt=""></a></div>
	</div>
	
	<div class="home-banners clearfix">
		<div class="small"><a href="#"><img src="image/catalog/modern/banner-03.jpg" alt=""></a></div>
		<div class="big"><a href="#"><img src="image/catalog/modern/banner-04.jpg" alt=""></a></div>
	</div>
</div>',
  ...
  array (
    ...
    'html' => 
    array (
      $language_id => '<div class="text-center"><a href="#" class="browse-all-products">Browse All Products</a></div>',
      1 => '<div class="text-center"><a href="#" class="browse-all-products">Browse All Products</a></div>',
      2 => '<div class="text-center"><a href="#" class="browse-all-products">Browse All Products</a></div>',
    ),
    'layout_id' => '1',
    'position' => 'preface_fullwidth',
    'status' => '1',
