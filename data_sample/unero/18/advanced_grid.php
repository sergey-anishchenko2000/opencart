...
<li><a target="_blank" href="#" class="fa fa-instagram"></a></li>
  ...
  array (
	...
	<div class="backgrounds">
		<div class="background active" style="background-image: url(image/catalog/slider/h-slider1.jpg)"></div>
		<div class="background" style="background-image: url(image/catalog/slider/h-slider2.jpg)"></div>
		<div class="background" style="background-image: url(image/catalog/slider/h-slider3.jpg)"></div>
		<div class="background" style="background-image: url(image/catalog/slider/h-slider4.jpg)"></div>
		<div class="background" style="background-image: url(image/catalog/slider/h-slider5.jpg)"></div>
	</div>
	...
	<div class="grid-items clearfix">
		...
		<div class="item">
			<a href="#" class="item-inner">
				...
				<span class="desc">Backpack, Duffles, Dawson...</span></a>
		</div>
		
		<div class="item">
			<a href="#" class="item-inner">
				<h2 class="title">Shoes</h2>
				<span class="desc">Sneaker, Leather, Boots</span></a>
		</div>
