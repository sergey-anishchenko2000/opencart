	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<div id="tb_store_select">
			...
			<?php foreach ($stores as $store): ?>
				<option value="<?php echo 'index.php?route=extension/module/unero&store_id=' . $store['store_id'] . '&user_token=' . $_GET['user_token']; ?>"<?php if($store_id == $store['store_id']) echo ' selected="selected"'; ?>><?php echo $store['name']; ?></option>
			<?php endforeach; ?>
			</select>
		</div>
				...
				<div class="bg-tabs">
					...
					<div id="tab_general" class="tab-content2">
						...
						<div id="tab_layout" class="tab-content">
							<h4>Body Custom Class</h4>
							<!-- Input -->
							<div class="input">
								<p>Body Custom Class:</p>
								<input type="text" name="body_custom_class" value="<?php echo $body_custom_class; ?>" />
								<div class="clear"></div>
							</div>
							
							<h4 style="padding-top:30px">Responsive Design</h4>
						...
						<div id="tab_translations" class="tab-content">
							...
							<div class="input">
								<p style="width:200px">Menu text:</p>
								<div class="list-language">
									<?php foreach($languages as $language) { ?>
									<div class="language">
										<?php $language_id = $language['language_id']; ?>
										<img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" />
										<input type="text" name="menu_text[<?php echo $language_id; ?>]" <?php if(isset($menu_text[$language_id])) { echo 'value="'.$menu_text[$language_id].'"'; } ?>>
									</div>
									<?php } ?>
								</div>
								<div class="clear"></div>
							...
							<div class="input">
								<p style="width:200px">Close search text:</p>
								<div class="list-language">
									<?php foreach($languages as $language) { ?>
									<div class="language">
										<?php $language_id = $language['language_id']; ?>
										<img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" alt="<?php echo $language['name']; ?>" width="16px" height="11px" />
										<input type="text" name="search_close_text[<?php echo $language_id; ?>]" <?php if(isset($search_close_text[$language_id])) { echo 'value="'.$search_close_text[$language_id].'"'; } ?>>
									</div>
									<?php } ?>
								</div>
								<div class="clear"></div>
						...
						<div id="tab_backgrounds" class="tab-content">
							...
							<div class="input">
								...
								<div class="own_image">
									...
									<?php } else { ?>
										<a href="" id="thumb-customfooter-background" class="img-thumbnail img-edit" data-toggle="image"><img src="../image/<?php echo $customfooter_background; ?>" data-placeholder="<?php echo $placeholder; ?>" alt="" /></a>
									<?php } ?>
								</div>
							...
							<div class="input">
								...
								<div class="own_image">
									<input type="hidden" name="content_headlines_background" value="<?php echo $content_headlines_background; ?>" id="input-content_headlines-background" />
									
									<?php if($content_headlines_background == '') { ?>
										<a href="" id="thumb-content_headlines-background" class="img-thumbnail img-edit" data-toggle="image"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
									<?php } else { ?>
										<a href="" id="thumb-content_headlines-background" class="img-thumbnail img-edit" data-toggle="image"><img src="../image/<?php echo $content_headlines_background; ?>" data-placeholder="<?php echo $placeholder; ?>" alt="" /></a>
									<?php } ?>
								</div>
							...
							<div class="input">
								...
								<div class="own_image">
									<input type="hidden" name="footer_headlines_background" value="<?php echo $footer_headlines_background; ?>" id="input-footer_headlines-background" />
									
									<?php if($footer_headlines_background == '') { ?>
										<a href="" id="thumb-footer_headlines-background" class="img-thumbnail img-edit" data-toggle="image"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
									<?php } else { ?>
										<a href="" id="thumb-footer_headlines-background" class="img-thumbnail img-edit" data-toggle="image"><img src="../image/<?php echo $footer_headlines_background; ?>" alt="" data-placeholder="<?php echo $placeholder; ?>" /></a>
									<?php } ?>
								</div>
					...
					<div id="tab_install_data" class="tab-content">
						...
						<div class="input" style="border: none">
							...
							<select name="select_demo" id="select_demo">
							     ...
							     <option value="2" <?php if($select_demo == '2'){echo ' selected="selected"';} ?>>home best selling</option>
							     <option value="3" <?php if($select_demo == '3'){echo ' selected="selected"';} ?>>home boxed</option>
							     <option value="4" <?php if($select_demo == '4'){echo ' selected="selected"';} ?>>home carousel</option>
							     <option value="5" <?php if($select_demo == '5'){echo ' selected="selected"';} ?>>home category</option>
							     <option value="6" <?php if($select_demo == '6'){echo ' selected="selected"';} ?>>home classic</option>
							     <option value="7" <?php if($select_demo == '7'){echo ' selected="selected"';} ?>>home collection</option>
							     <option value="8" <?php if($select_demo == '8'){echo ' selected="selected"';} ?>>home grid background</option>
							     <option value="9" <?php if($select_demo == '9'){echo ' selected="selected"';} ?>>home instagram</option>
							     <option value="10" <?php if($select_demo == '10'){echo ' selected="selected"';} ?>>home metro</option>
							     <option value="11" <?php if($select_demo == '11'){echo ' selected="selected"';} ?>>home minimal</option>
							     <option value="12" <?php if($select_demo == '12'){echo ' selected="selected"';} ?>>home modern</option>
							     <option value="13" <?php if($select_demo == '13'){echo ' selected="selected"';} ?>>home parallax</option>
							     <option value="14" <?php if($select_demo == '14'){echo ' selected="selected"';} ?>>home product landing</option>
							     <option value="15" <?php if($select_demo == '15'){echo ' selected="selected"';} ?>>home products</option>
							     <option value="16" <?php if($select_demo == '16'){echo ' selected="selected"';} ?>>home recent products</option>
							     <option value="17" <?php if($select_demo == '17'){echo ' selected="selected"';} ?>>home simple</option>
							     <option value="18" <?php if($select_demo == '18'){echo ' selected="selected"';} ?>>home slider</option>
							     <option value="19" <?php if($select_demo == '19'){echo ' selected="selected"';} ?>>home split screen</option>
							     <option value="20" <?php if($select_demo == '20'){echo ' selected="selected"';} ?>>home video banner</option>
							</select>
						...
						<div class="input versions version-1 version-2 version-3 version-4 version-5 version-6 version-7 version-8 version-9 version-10 version-11 version-12 version-13 version-14 version-15 version-16 version-17 version-18 version-19 version-20">
						...
						<div class="input versions version-1 version-3 version-7 version-11 version-12 version-20">
						...
						<div class="input versions version-1 version-2 version-4 version-5 version-6 version-7 version-8 version-9 version-10 version-11 version-12 version-13 version-14 version-15 version-16 version-17 version-18 version-19 version-20">
						...
						<div class="input versions version-3 version-12 version-17 version-20" style="display: none">
							<p style="width:240px">Blog latest:</p>
