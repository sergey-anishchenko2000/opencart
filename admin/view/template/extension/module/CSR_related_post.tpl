...
<div id="content"><div class="container-fluid">
	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		<div class="set-size" id="CSR_related_post">
			<div class="content">
				<div>
					<div class="tabs clearfix">
						...
						<div id="tab-module-<?php echo $module_row; ?>" class="tab-content">
                            ...
                            <div id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
                              <div class="block<?php echo $module_row; ?>">
                                  <table class="form">
                                    <tr>
                                      <td>Block heading:</td>
                                      <td><input type="text" value="<?php echo isset($module['heading_title'][$language['language_id']]) ? $module['heading_title'][$language['language_id']] : ''; ?>" name="CSR_related_post_module[<?php echo $module_row; ?>][heading_title][<?php echo $language['language_id']; ?>]" style="width:250px"></td>
                                    </tr>
                                  </table>	
                              </div>
                            </div>
							...
							<table class="form">
							  <tr>
							    <td>Layout:</td>
							    <td><select name="CSR_related_post_module[<?php echo $module_row; ?>][layout_id]">
							  ...
							  <tr>
							    <td>Position:</td>
							    <td><select name="CSR_related_post_module[<?php echo $module_row; ?>][position]">
						     	...
						     	<?php } ?>
							    	...
							    	<?php } ?>
							    	<?php if ($module['position'] == 'CSR_center') { ?>
							    	<option value="CSR_center" selected="selected">CSR center</option>
							    	<?php } else { ?>
							    	<option value="CSR_center">CSR center</option>
							    	<?php } ?>
                                                ...
                                                if (isset($article_popular_templates[$template])) {
                                                    ...
                                                    foreach ($article_popular_templates[$template] as $file_template) {
                                                        ...
                                                        <div class="module-layout clearfix">
                                                            <input type="radio" name="CSR_related_post_module[<?php echo $module_row; ?>][template]" value="<?php echo $file_template; ?>" <?php if (isset($module['template']) && $module['template'] == $file_template) echo 'checked="checked"'; ?> class="input-article-popular-template">
							  ...
							  <tr>
							    <td>Status:</td>
							    <td><select name="CSR_related_post_module[<?php echo $module_row; ?>][status]">
                              ...
                              <tr>
                                    ...
                                    <td>
                                        <input type="text" name="CSR_related_post_module[<?php echo $module_row; ?>][thumb_width]" value="<?php echo $module['thumb_width']; ?>"  style="width: 50px; display: inline-block; margin-right: 0;"/>
                                        x
                                        <input type="text" name="CSR_related_post_module[<?php echo $module_row; ?>][thumb_height]" value="<?php echo $module['thumb_height']; ?>"  style="width: 50px; display: inline-block; margin-right: 0;"/>
                                    </td>
                              </tr>
                              <tr>
							    <td>Articles Limit:</td>
							    <td><input type="text" name="CSR_related_post_module[<?php echo $module_row; ?>][articles_limit]" value="<?php echo $module['articles_limit']; ?>" size="3" /></td>
							  </tr>
                              <tr>
							    <td>Sort Order:</td>
							    <td><input type="text" name="CSR_related_post_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
							  </tr>
...
function addModule() {	
	html  = '<div id="tab-module-' + module_row + '" class="tab-content">';
		...
		html += '				<td><input type="text" value="" name="CSR_related_post_module[' + module_row + '][heading_title][<?php echo $language['language_id']; ?>]" style="width:250px"></td>';
		html += '			</tr>';
		html += '	   </table>';
		html += '	 </div>';
		...
		html += '    <tr>';
		html += '      <td>Layout:</td>';
		html += '      <td><select name="CSR_related_post_module[' + module_row + '][layout_id]">';
		...
		html += '    <tr>';
		html += '      <td>Position:</td>';
		html += '      <td><select name="CSR_related_post_module[' + module_row + '][position]">';
		...
		html += '				<option value="CSR_center">CSR center</option>';
        ...
        html += '                                       <input type="radio" name="CSR_related_post_module[<?php echo $module_row; ?>][template]" value="<?php echo $file_template; ?>"  class="input-article-popular-template">';
		...
		html += '    <tr>';
		html += '      <td>Status:</td>';
		html += '      <td><select name="CSR_related_post_module[' + module_row + '][status]">';
        ...
        html += '       <td>';
        html += '          <input type="text" name="CSR_related_post_module[<?php echo $module_row; ?>][thumb_width]" value=""  style="width: 50px; display: inline-block; margin-right: 0;"/>';
        html += '           x';
        html += '           <input type="text" name="CSR_related_post_module[<?php echo $module_row; ?>][thumb_height]" value=""  style="width: 50px; display: inline-block; margin-right: 0;"/>';
        html += '       </td>';
        html += '    </tr>';
		html += '    <tr>';
		html += '      <td>Articles Limit:</td>';
		html += '      <td><input type="text" name="CSR_related_post_module[' + module_row + '][articles_limit]" value="" size="3" /></td>';
		html += '    </tr>';
		html += '    <tr>';
		html += '      <td>Sort Order:</td>';
		html += '      <td><input type="text" name="CSR_related_post_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
		html += '    </tr>';
		html += '  </table>'; 
	html += '</div>';
