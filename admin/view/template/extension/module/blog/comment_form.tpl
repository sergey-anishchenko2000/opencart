            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-comment" class="form-horizontal">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <a href="<?php echo $article_href ?>" target="_blank" style="position: relative; top: 8px "><?php echo $article_title ?></a>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-description"><?php echo $entry_content; ?></label>
                        <div class="col-sm-10">
                            <textarea name="content" placeholder="<?php echo $entry_content; ?>" id="input-description" class="form-control"><?php echo isset($content) ? $content : ''; ?></textarea>
                        </div>
                    </div>
