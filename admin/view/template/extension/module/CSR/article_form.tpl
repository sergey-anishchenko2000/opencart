  ...
  <?php } ?>
    ...
    $('input[name=\'category\']').autocomplete({
        'source': function(request, response) {
            $.ajax({
                url: 'index.php?route=extension/module/CSR/category_autocomplete&user_token=<?php echo $user_token; ?>&filter_name=' +  encodeURIComponent(request),
                dataType: 'json',			
    ...
    $('input[name=\'related_articles\']').autocomplete({
        'source': function(request, response) {
            $.ajax({
                url: 'index.php?route=extension/module/CSR/article_autocomplete&user_token=<?php echo $user_token; ?>&filter_title=' +  encodeURIComponent(request),
                dataType: 'json',			
                success: function(json) {
                    response($.map(json, function(item) {
                        return {
