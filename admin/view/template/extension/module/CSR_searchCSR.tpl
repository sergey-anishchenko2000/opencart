...
<div id="content"><div class="container-fluid">
	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		<div class="set-size" id="CSR_search">
			<div class="content">
				<div>
					<div class="tabs clearfix">
						...
						<div id="tab-module-<?php echo $module_row; ?>" class="tab-content">
                            ...
                            <div id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
                              <div class="block<?php echo $module_row; ?>">
                                  <table class="form">
                                    <tr>
                                      <td>Block heading:</td>
                                      <td><input type="text" value="<?php echo isset($module['heading_title'][$language['language_id']]) ? $module['heading_title'][$language['language_id']] : ''; ?>" name="CSR_search_module[<?php echo $module_row; ?>][heading_title][<?php echo $language['language_id']; ?>]" style="width:250px"></td>
                                    </tr>
                                  </table>	
                              </div>
                            </div>
							...
							<table class="form">
							  <tr>
							    <td>Layout:</td>
							    <td><select name="CSR_search_module[<?php echo $module_row; ?>][layout_id]">
							  ...
							  <tr>
							    <td>Position:</td>
							    <td><select name="CSR_search_module[<?php echo $module_row; ?>][position]">
							  ...
							  <tr>
							    <td>Status:</td>
							    <td><select name="CSR_search_module[<?php echo $module_row; ?>][status]">
							  ...
							  <tr>
							    <td>Sort Order:</td>
							    <td><input type="text" name="CSR_search_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
							  </tr>
							</table>
						</div>
						<?php $module_row++; ?>
...
function addModule() {	
	html  = '<div id="tab-module-' + module_row + '" class="tab-content">';
		...
		html += '				<td><input type="text" value="" name="CSR_search_module[' + module_row + '][heading_title][<?php echo $language['language_id']; ?>]" style="width:250px"></td>';
		html += '			</tr>';
		html += '	   </table>';
		html += '	 </div>';
		...
		html += '    <tr>';
		html += '      <td>Layout:</td>';
		html += '      <td><select name="CSR_search_module[' + module_row + '][layout_id]">';
		...
		html += '    <tr>';
		html += '      <td>Position:</td>';
		html += '      <td><select name="CSR_search_module[' + module_row + '][position]">';
		...
		html += '    <tr>';
		html += '      <td>Status:</td>';
		html += '      <td><select name="CSR_search_module[' + module_row + '][status]">';
		...
		html += '      <td><input type="text" name="CSR_search_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
		html += '    </tr>';
		html += '  </table>'; 
	html += '</div>';
