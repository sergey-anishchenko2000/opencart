						...
						<div id="tab-module-<?php echo $module_row; ?>" class="tab-content">
							...
							<table class="form">
                              ...
                              <tr>
                                    ...
                                    <td>
                                        <input type="text" name="blog_related_post_module[<?php echo $module_row; ?>][thumb_width]" value="<?php echo $module['thumb_width']; ?>"  style="width: 50px; display: inline-block; margin-right: 0;"/>
                                        x
                                        <input type="text" name="blog_related_post_module[<?php echo $module_row; ?>][thumb_height]" value="<?php echo $module['thumb_height']; ?>"  style="width: 50px; display: inline-block; margin-right: 0;"/>
                                    </td>
                              </tr>
                              <tr>
...
function addModule() {	
	html  = '<div id="tab-module-' + module_row + '" class="tab-content">';
        ...
        html += '       <td>';
        html += '          <input type="text" name="blog_related_post_module[<?php echo $module_row; ?>][thumb_width]" value=""  style="width: 50px; display: inline-block; margin-right: 0;"/>';
        html += '           x';
        html += '           <input type="text" name="blog_related_post_module[<?php echo $module_row; ?>][thumb_height]" value=""  style="width: 50px; display: inline-block; margin-right: 0;"/>';
        html += '       </td>';
        html += '    </tr>';
		html += '    <tr>';
