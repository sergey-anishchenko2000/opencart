...
class ControllerExtensionModuleCSR extends Controller {
	private $error = array(); 
    
    public function __construct($registry) {
        parent::__construct($registry);
        
        $this->load->language('extension/module/CSR');
    ...
    {
        $data['text_CSR_dashboard'] = $this->language->get('text_CSR_dashboard');
        ...
        $data['text_CSR_category'] = $this->language->get('text_CSR_category');
        $data['text_CSR_search'] = $this->language->get('text_CSR_search');
        $data['text_CSR_latest_post'] = $this->language->get('text_CSR_latest_post');
        $data['text_CSR_popular_post'] = $this->language->get('text_CSR_popular_post');
        $data['text_CSR_product_related_post'] = $this->language->get('text_CSR_product_related_post');
        $data['text_CSR_popular_tags'] = $this->language->get('text_CSR_popular_tags');
        
        $data['link_CSR_dashboard'] = $this->url->link('extension/module/CSR', 'user_token=' . $this->session->data['user_token'], true);
        $data['link_add_edit_categories'] = $this->url->link('extension/module/CSR/category_list', 'user_token=' . $this->session->data['user_token'], true);
        $data['link_add_edit_articles'] = $this->url->link('extension/module/CSR/article_list', 'user_token=' . $this->session->data['user_token'], true);
        $data['link_add_edit_authors'] = $this->url->link('extension/module/CSR/author_list', 'user_token=' . $this->session->data['user_token'], true);
        $data['link_add_edit_comments'] = $this->url->link('extension/module/CSR/comment_list', 'user_token=' . $this->session->data['user_token'], true);
        $data['link_general_settings'] = $this->url->link('extension/module/CSR/settings', 'user_token=' . $this->session->data['user_token'], true);
        
        $data['link_CSR_category'] = $this->url->link('extension/module/CSR_category', 'user_token=' . $this->session->data['user_token'], true);
        $data['link_CSR_search'] = $this->url->link('extension/module/CSR_search', 'user_token=' . $this->session->data['user_token'], true);
        $data['link_CSR_latest_post'] = $this->url->link('extension/module/CSR_latest', 'user_token=' . $this->session->data['user_token'], true);
        $data['link_CSR_popular_post'] = $this->url->link('extension/module/CSR_popular', 'user_token=' . $this->session->data['user_token'], true);
        $data['link_CSR_product_related_post'] = $this->url->link('extension/module/CSR_related_post', 'user_token=' . $this->session->data['user_token'], true);
        $data['link_CSR_popular_tags'] = $this->url->link('extension/module/CSR_tags', 'user_token=' . $this->session->data['user_token'], true);
	...
	public function index() {   
        ...
        $data['text_CSR_front_information'] = sprintf($this->language->get('text_CSR_front_information'), $front_url->link('CSR/CSR'));

        $this->document->setTitle($data['text_CSR_dashboard']);
		...
		$data['action'] = $this->url->link('extension/module/CSR', 'user_token=' . $this->session->data['user_token'], true);
		...
		$data['breadcrumbs'][] = array(
			'text' => $data['text_CSR_dashboard'],
			'href' => $this->url->link('extension/module/CSR', 'user_token=' . $this->session->data['user_token'], true)
		);
        ...
        $data['handy_box'] = $this->load->view('extension/module/CSR/partial/header', $data);
		$this->response->setOutput($this->load->view('extension/module/CSR/CSR', $data));
	}
    ...
    public function article_list()
    {
		...
		$this->load->language('extension/module/CSR/article');

		$this->document->setTitle($this->language->get('heading_title'));
        

		$this->load->model('CSR/article');
		$this->load->model('CSR/comment');
	...
	public function article_add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateArticleForm()) {
			$this->model_CSR_article->addArticle($this->request->post);
			...
			$this->response->redirect($this->url->link('extension/module/CSR/article_list', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	public function article_edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateArticleForm()) {
            ...
            $this->model_CSR_article->editArticle($this->request->get['article_id'], $this->request->post);
	...
	public function article_delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateArticleDelete()) {
			foreach ($this->request->post['selected'] as $article_id) {
				$this->model_CSR_article->deleteArticle($article_id);
			}
	...
	protected function getArticlesList() {
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('text_CSR_dashboard'),
			'href' => $this->url->link('extension/module/CSR', 'user_token=' . $this->session->data['user_token'], true)
		);
				
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('text_articles'),
			'href' => $this->url->link('extension/module/CSR/article_list', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['add'] = $this->url->link('extension/module/CSR/article_add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('extension/module/CSR/article_delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$article_total = $this->model_CSR_article->getTotalArticles($filter_data);

		$results = $this->model_CSR_article->getArticles($filter_data);
		...
		foreach ($results as $result) {
			$data['articles'][] = array(
				...
				'author'  => '<a target="_blank" href="'.$this->url->link('extension/module/CSR/author_list', 'user_token=' . $this->session->data['user_token'] . '&author_id=' . $result['author_id'] . $url, true).'">'.$result['author'] .'</a>',
                'comments'    => $this->model_CSR_comment->getTotalArticleComments($result['article_id']),
				'edit'        => $this->url->link('extension/module/CSR/article_edit', 'user_token=' . $this->session->data['user_token'] . '&article_id=' . $result['article_id'] . $url, true),
				'delete'      => $this->url->link('extension/module/CSR/article_delete', 'user_token=' . $this->session->data['user_token'] . '&article_id=' . $result['article_id'] . $url, true)
			);
		}
		...
		$data['sort_title'] = $this->url->link('extension/module/CSR/article_list', 'user_token=' . $this->session->data['user_token'] . '&sort=title' . $url, true);
		$data['sort_date_published'] = $this->url->link('extension/module/CSR/article_list', 'user_token=' . $this->session->data['user_token'] . '&sort=date_published' . $url, true);
		$data['sort_author'] = $this->url->link('extension/module/CSR/article_list', 'user_token=' . $this->session->data['user_token'] . '&sort=author' . $url, true);
		...
		$pagination->url = $this->url->link('extension/module/CSR/article_list', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('extension/module/CSR/partial/header', $data);
		$this->response->setOutput($this->load->view('extension/module/CSR/article_list', $data));
	}
	...
	protected function getArticleForm() {
		...
		if (!isset($this->request->get['article_id'])) {
			$data['action'] = $this->url->link('extension/module/CSR/article_add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('extension/module/CSR/article_edit', 'user_token=' . $this->session->data['user_token'] . '&article_id=' . $this->request->get['article_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('extension/module/CSR/article_list', 'user_token=' . $this->session->data['user_token'] . $url, true);

		if (isset($this->request->get['article_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$article_info = $this->model_CSR_article->getArticle($this->request->get['article_id']);
		}
		...
		// Categories
        $this->load->model('CSR/category');
        
		if (isset($this->request->post['article_category'])) {
			$categories = $this->request->post['article_category'];
		} elseif (isset($this->request->get['article_id'])) {
			$categories = $this->model_CSR_article->getArticleCategories($this->request->get['article_id']);
		} else {
			$categories = array();
		}
		...
		foreach ($categories as $category_id) {
			$category_info = $this->model_CSR_category->getCategory($category_id);
        ...
        //Author
        $this->load->model('CSR/author');
        $data['authors'] = $this->model_CSR_author->getAuthors();

		if (isset($this->request->post['article_description'])) {
			$data['article_description'] = $this->request->post['article_description'];
		} elseif (isset($this->request->get['article_id'])) {
			$data['article_description'] = $this->model_CSR_article->getArticleDescriptions($this->request->get['article_id']);
		} else {
		...
		if (isset($this->request->post['article_store'])) {
			...
			$data['article_store'] = $this->model_CSR_article->getArticleStores($this->request->get['article_id']);
		} else {
		...
		if (isset($this->request->post['product_related'])) {
			...
			$products = $this->model_CSR_article->getProductRelated($this->request->get['article_id']);
		} else {
			$products = array();
		}
		...
		if (isset($this->request->post['article_related'])) {
			...
			$articles = $this->model_CSR_article->getArticleRelated($this->request->get['article_id']);
		} else {
			$articles = array();
		}
		...
		foreach ($articles as $article_id) {
			$related_info = $this->model_CSR_article->getArticle($article_id);
		...
		if (isset($this->request->post['article_gallery'])) {
			...
			$article_galleries = $this->model_CSR_article->getArticleGalleries($this->request->get['article_id']);
		} else {
		...
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('extension/module/CSR/partial/header', $data);
		$this->response->setOutput($this->load->view('extension/module/CSR/article_form', $data));
	}

	protected function validateArticleForm() {
		if (!$this->user->hasPermission('modify', 'extension/module/CSR')) {
    ...
    {
		$this->load->language('extension/module/CSR/category');
	...
	public function category_add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateCategoryForm()) {
			$this->model_CSR_category->addCategory($this->request->post);
			...
			$this->response->redirect($this->url->link('extension/module/CSR/category_list', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	public function category_edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateCategoryForm()) {
			$this->model_CSR_category->editCategory($this->request->get['category_id'], $this->request->post);
	...
	public function category_delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateCategoryDelete()) {
			foreach ($this->request->post['selected'] as $category_id) {
				$this->model_CSR_category->deleteCategory($category_id);
			}
	...
	protected function getCategoriesList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/CSR/category_list', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['add'] = $this->url->link('extension/module/CSR/category_add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('extension/module/CSR/category_delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$category_total = $this->model_CSR_category->getTotalCategories();

		$results = $this->model_CSR_category->getCategories($filter_data);
		...
		foreach ($results as $result) {
			$data['categories'][] = array(
				...
				'edit'        => $this->url->link('extension/module/CSR/category_edit', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $result['category_id'] . $url, true),
				'delete'      => $this->url->link('extension/module/CSR/category_delete', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $result['category_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('extension/module/CSR/category_list', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('extension/module/CSR/category_list', 'user_token=' . $this->session->data['user_token'] . '&sort=sort_order' . $url, true);
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('extension/module/CSR/category_list', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('extension/module/CSR/partial/header', $data);
		$this->response->setOutput($this->load->view('extension/module/CSR/category_list', $data));
	}
	...
	protected function getCategoryForm() {
		...
		if (!isset($this->request->get['category_id'])) {
			$data['action'] = $this->url->link('extension/module/CSR/category_add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('extension/module/CSR/category_edit', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $this->request->get['category_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('extension/module/CSR/category_list', 'user_token=' . $this->session->data['user_token'] . $url, true);

		if (isset($this->request->get['category_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$category_info = $this->model_CSR_category->getCategory($this->request->get['category_id']);
		}
		...
		if (isset($this->request->post['category_description'])) {
			...
			$data['category_description'] = $this->model_CSR_category->getCategoryDescriptions($this->request->get['category_id']);
		} else {
		...
		if (isset($this->request->post['category_store'])) {
			...
			$data['category_store'] = $this->model_CSR_category->getCategoryStores($this->request->get['category_id']);
		} else {
		...
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('extension/module/CSR/partial/header', $data);
		$this->response->setOutput($this->load->view('extension/module/CSR/category_form', $data));
	}
    ...
    public function comment_list() {
		$this->load->language('extension/module/CSR/comment');
	...
	public function comment_add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateCommentForm()) {
			$this->model_CSR_comment->addComment($this->request->post);
			...
			$this->response->redirect($this->url->link('extension/module/CSR/comment_list', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	public function comment_edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateCommentForm()) {
			$this->model_CSR_comment->editComment($this->request->get['comment_id'], $this->request->post);
	...
	public function comment_delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateCommentDelete()) {
			foreach ($this->request->post['selected'] as $comment_id) {
				$this->model_CSR_comment->deleteComment($comment_id);
			}
	...
	protected function getCommentList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/CSR/comment_list', 'user_token=' . $this->session->data['user_token'], true)
		);
        
		$data['add'] = $this->url->link('extension/module/CSR/comment_add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('extension/module/CSR/comment_delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$comment_total = $this->model_CSR_comment->getTotalComments();

		$results = $this->model_CSR_comment->getComments($filter_data);

        // Article
        $this->load->model('CSR/article');
        
		foreach ($results as $result) {
            $article_info = $this->model_CSR_article->getArticle($result['article_id']);
			$data['comments'][] = array(
                ...
                'article_href'     => $this->url->link('extension/module/CSR/article_edit', 'user_token=' . $this->session->data['user_token'] . '&article_id=' . $result['article_id'], true),
				'edit'            => $this->url->link('extension/module/CSR/comment_edit', 'user_token=' . $this->session->data['user_token'] . '&comment_id=' . $result['comment_id'] . $url, true)
			);
		...
		$data['sort_name'] = $this->url->link('extension/module/CSR/comment_list', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, true);
		$data['sort_email'] = $this->url->link('extension/module/CSR/comment_list', 'user_token=' . $this->session->data['user_token'] . '&sort=email' . $url, true);
		$data['sort_date_added'] = $this->url->link('extension/module/CSR/comment_list', 'user_token=' . $this->session->data['user_token'] . '&sort=date_added' . $url, true);
		$data['sort_status'] = $this->url->link('extension/module/CSR/comment_list', 'user_token=' . $this->session->data['user_token'] . '&sort=status' . $url, true);
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('extension/module/CSR/comment_list', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('extension/module/CSR/partial/header', $data);
		$this->response->setOutput($this->load->view('extension/module/CSR/comment_list', $data));
	}
	...
	protected function getCommentForm() {
		...
		if (!isset($this->request->get['comment_id'])) {
			$data['action'] = $this->url->link('extension/module/CSR/comment_add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('extension/module/CSR/comment_edit', 'user_token=' . $this->session->data['user_token'] . '&comment_id=' . $this->request->get['comment_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('extension/module/CSR/comment', 'user_token=' . $this->session->data['user_token'] . $url, true);

		if (isset($this->request->get['comment_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$comment_info = $this->model_CSR_comment->getComment($this->request->get['comment_id']);
		}
        ...
        // Article
        $this->load->model('CSR/article');
        $article_info = $this->model_CSR_article->getArticle($comment_info['article_id']);
        $data['article_title'] = $article_info['title'];
        $data['article_href'] = $this->url->link('extension/module/CSR/article_edit', 'user_token=' . $this->session->data['user_token'] . '&article_id=' . $comment_info['article_id'], true);

		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('extension/module/CSR/partial/header', $data);
		$this->response->setOutput($this->load->view('extension/module/CSR/comment_form', $data));
	}
    ...
    public function author_list() {
		$this->load->language('extension/module/CSR/author');
	...
	public function author_add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateAuthorForm()) {
			$this->model_CSR_author->addAuthor($this->request->post);
			...
			$this->response->redirect($this->url->link('extension/module/CSR/author_list', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	public function author_edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateAuthorForm()) {
			$this->model_CSR_author->editAuthor($this->request->get['author_id'], $this->request->post);
	...
	public function author_delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateAuthorDelete()) {
			foreach ($this->request->post['selected'] as $author_id) {
				$this->model_CSR_author->deleteAuthor($author_id);
			}
	...
	protected function getAuthorList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/CSR/author_list', 'user_token=' . $this->session->data['user_token'], true)
		);
        
		$data['add'] = $this->url->link('extension/module/CSR/author_add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('extension/module/CSR/author_delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$author_total = $this->model_CSR_author->getTotalAuthors();

		$results = $this->model_CSR_author->getAuthors($filter_data);
		...
		foreach ($results as $result) {
			$data['authors'][] = array(
				...
				'name'            => $result['name'],
				'sort_order'      => $result['sort_order'],
				'edit'            => $this->url->link('extension/module/CSR/author_edit', 'user_token=' . $this->session->data['user_token'] . '&author_id=' . $result['author_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('extension/module/CSR/author_list', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('extension/module/CSR/author_list', 'user_token=' . $this->session->data['user_token'] . '&sort=sort_order' . $url, true);
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('extension/module/CSR/author_list', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('extension/module/CSR/partial/header', $data);
		$this->response->setOutput($this->load->view('extension/module/CSR/author_list', $data));
	}
	...
	protected function getAuthorForm() {
        ...
        if (isset($this->request->post['author_description'])) {
			...
			$data['author_description'] = $this->model_CSR_author->getAuthorDescriptions($this->request->get['author_id']);
		} else {
		...
		if (!isset($this->request->get['author_id'])) {
			$data['action'] = $this->url->link('extension/module/CSR/author_add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('extension/module/CSR/author_edit', 'user_token=' . $this->session->data['user_token'] . '&author_id=' . $this->request->get['author_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('extension/module/CSR/author', 'user_token=' . $this->session->data['user_token'] . $url, true);

		if (isset($this->request->get['author_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$author_info = $this->model_CSR_author->getAuthor($this->request->get['author_id']);
		}
		...
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('extension/module/CSR/partial/header', $data);
		$this->response->setOutput($this->load->view('extension/module/CSR/author_form', $data));
	}
    ...
    // SETTIGNGS
		...
		$this->load->language('extension/module/CSR/settings');

		$this->document->setTitle($this->language->get('heading_title'));

		$this->load->model('CSR/settings');

		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateSettingsForm()) {

            $this->model_CSR_settings->editSettings($this->request->post);
			...
			$this->response->redirect($this->url->link('extension/module/CSR/settings', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	protected function getSettingsForm() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/CSR/settings', 'user_token=' . $this->session->data['user_token'], true)
		);

        $data['action'] = $this->url->link('extension/module/CSR/settings', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['cancel'] = $this->url->link('extension/module/CSR', 'user_token=' . $this->session->data['user_token'] . $url, true);

        $settings_info = $this->model_CSR_settings->getSettings();
        ...
        // Åadowanie templatek moduÅÃ³w
		...
		foreach ($directories as $directory) {
			...
			$files_article_list = glob(DIR_CATALOG . 'view/theme/' . $directory . '/template/CSR/article_list/*.tpl');
			$files_article_detail = glob(DIR_CATALOG . 'view/theme/' . $directory . '/template/CSR/article_detail/*.tpl');
			$files_article_related = glob(DIR_CATALOG . 'view/theme/' . $directory . '/template/CSR/article_related/*.tpl');
		...
		$data['footer'] = $this->load->controller('common/footer');
          $data['handy_box'] = $this->load->view('extension/module/CSR/partial/header', $data);
		$this->response->setOutput($this->load->view('extension/module/CSR/settings_form', $data));
	}
    ...
    function install()
    {
        $this->load->model('CSR/setup');
        $this->model_CSR_setup->install();
    }
    
    function uninstall()
    {
        $this->load->model('CSR/setup');
        $this->model_CSR_setup->uninstall();
    }
}
?>