...
class ModelCatalogDistributorLocation extends Model {
	public function addLocation($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "distributor_location SET name = '" . $this->db->escape($data['name']) . "', sort_order = '" . (int)$data['sort_order'] . "'");
	...
	public function editLocation($location_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "distributor_location SET name = '" . $this->db->escape($data['name']) . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE location_id = '" . (int)$location_id . "'");
