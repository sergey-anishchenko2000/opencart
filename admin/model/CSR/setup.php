<?php
class ModelCSRsetup extends Model
{
    public function install(){
		$sql = " SHOW TABLES LIKE '".DB_PREFIX."CSR%'";
	...
	public function createTables(){
		$queries = array();
		$queries[] = "
            CREATE TABLE `".DB_PREFIX."CSR_article` (
		...
		";
		$queries[] = "
            CREATE TABLE `".DB_PREFIX."CSR_article_description` (
		...
		";
		$queries[] = "
            CREATE TABLE `".DB_PREFIX."CSR_article_gallery` (
		...
		";
		$queries[] = "
            CREATE TABLE `".DB_PREFIX."CSR_article_to_store` (
                `article_id` INT(11) NOT NULL,
		...
		";
		$queries[] = "
            CREATE TABLE `".DB_PREFIX."CSR_article_related` (
                `article_id` INT(11) NOT NULL,
		...
		";
		$queries[] = "
            CREATE TABLE `".DB_PREFIX."CSR_article_to_category` (
                `article_id` INT(11) NOT NULL,
		...
		";
		$queries[] = "
            CREATE TABLE `".DB_PREFIX."CSR_category_to_store` (
                `category_id` INT(11) NOT NULL,
                `store_id` INT(11) NOT NULL,
		...
		";
		$queries[] = "
            CREATE TABLE `".DB_PREFIX."CSR_author` (
		...
		";
		$queries[] = "
            CREATE TABLE `".DB_PREFIX."CSR_author_description` (
                `author_id` INT(11) NOT NULL,
                `language_id` INT(11) NOT NULL,
                `description` TEXT NOT NULL,
		...
		";
		$queries[] = "
            CREATE TABLE `".DB_PREFIX."CSR_category` (
		...
		";
		$queries[] = "
            CREATE TABLE `".DB_PREFIX."CSR_category_description` (
                `category_id` INT(11) NOT NULL,
                `language_id` INT(11) NOT NULL,
                `name` VARCHAR(255) NOT NULL,
                `description` TEXT NOT NULL,
		...
		";
		$queries[] = "
            CREATE TABLE `".DB_PREFIX."CSR_category_path` (
                `category_id` INT(11) NOT NULL,
		...
		";
		$queries[] = "
            CREATE TABLE `".DB_PREFIX."CSR_comment` (
		...
		$queries[] = "
            CREATE TABLE `".DB_PREFIX."CSR_product_related` (
                `article_id` INT(11) NOT NULL,
                `related_id` INT(11) NOT NULL,
                PRIMARY KEY (`related_id`, `article_id`)
            )
		...
		";
		$queries[] = "
            CREATE TABLE `".DB_PREFIX."CSR_settings` (
        ...
        // INSERT LAYOUT
        $this->db->query("INSERT INTO " . DB_PREFIX . "layout SET name = 'CSR'");

		$layout_id = $this->db->getLastId();
        $this->db->query("INSERT INTO " . DB_PREFIX . "layout_route SET layout_id = '" . (int)$layout_id . "', store_id = '0', route = 'CSR/CSR'");
        $this->db->query("INSERT INTO " . DB_PREFIX . "layout_route SET layout_id = '" . (int)$layout_id . "', store_id = '0', route = 'CSR/article'"); 
        
        $this->load->model('setting/store');
		$stores = $this->model_setting_store->getStores();
        if(!empty($stores)){
            foreach($stores as $store){
                $this->db->query("INSERT INTO " . DB_PREFIX . "layout_route SET layout_id = '" . (int)$layout_id . "', store_id = '" . (int)$store['store_id'] . "', route = 'CSR/CSR'");
                $this->db->query("INSERT INTO " . DB_PREFIX . "layout_route SET layout_id = '" . (int)$layout_id . "', store_id = '" . (int)$store['store_id'] . "', route = 'CSR/article'"); 
            }
        }
	...
	public function dropTables(){
		$queries = array();
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_article`
		";
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_article_description`
		";
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_article_gallery`
		";
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_article_to_store`
		";
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_article_related`
		";
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_article_to_category`
		";
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_author`
		";
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_author_description`
		";
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_category`
		";
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_category_description`
		";
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_category_path`
		";
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_category_to_store`
		";
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_comment`
		";
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_comment_description`
		";
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_product_related`
		";
		$queries[] = "
			DROP TABLE IF EXISTS `".DB_PREFIX."CSR_settings`
		";
        ...
        // Delete layout
        $query = $this->db->query("SELECT layout_id FROM " . DB_PREFIX . "layout WHERE name = 'CSR'");
    ...
    function installSampleData()
    {
		...
		if( count($query->rows) > 0){
			...
			$queries[] = "
                    INSERT INTO `" . DB_PREFIX . "CSR_article` (`article_id`, `author_id`, `article_list_gallery_display`, `sort_order`, `image`, `status`, `status_comments`, `date_added`, `date_published`, `date_updated`) VALUES
                    (27, 0, 'CLASSIC', 2, 'catalog/CSR/16.jpg', 1, 1, '2015-09-16 00:10:18', '2015-09-16 00:09:56', '2015-09-16 00:09:56'),
                    (18, 0, 'SLIDER', 2, 'catalog/CSR/laptopmockup_sliderdy-150x150.jpg', 1, 1, '2015-09-16 00:10:24', '2015-09-16 00:00:02', '2015-09-16 00:00:02'),
                    (65, 0, 'CLASSIC', 0, 'catalog/CSR/4.jpg', 1, 1, '2015-09-12 16:49:41', '2015-09-12 16:49:41', '2015-09-12 16:49:41'),
                    (64, 0, 'SLIDER', 0, 'catalog/CSR/3.jpg', 1, 1, '2015-09-06 18:50:44', '2015-09-06 18:50:44', '2015-09-06 18:50:44'),
                    (25, 0, 'CLASSIC', 3, 'catalog/CSR/5.jpg', 1, 1, '2015-09-03 01:09:25', '2015-09-03 01:09:25', '2015-09-03 01:09:25'),
                    (20, 0, 'CLASSIC', 1, 'catalog/CSR/6.jpg', 1, 1, '2015-09-01 21:09:43', '2015-09-01 21:09:43', '2015-09-01 21:09:43'),
                    (63, 0, 'CLASSIC', 0, 'catalog/CSR/7.jpg', 1, 1, '2015-08-27 00:08:35', '2015-08-26 22:16:12', '2015-08-26 22:16:12'),
                    (34, 0, 'CLASSIC', 7, 'catalog/CSR/2-150x150.jpg', 1, 0, '2015-09-16 22:27:46', '2015-08-11 12:22:11', '2015-08-11 12:22:11'),
                    (66, 0, 'CLASSIC', 0, 'catalog/CSR/9.jpg', 1, 1, '2014-01-21 15:01:26', '2014-01-21 15:01:26', '2014-01-21 15:01:26'),
                    (67, 0, 'CLASSIC', 0, 'catalog/CSR/12.jpg', 1, 1, '2013-11-19 15:11:57', '2013-11-19 15:11:57', '2013-11-19 15:11:57'),
                    (68, 0, 'CLASSIC', 0, 'catalog/CSR/13.jpg', 1, 1, '2014-10-19 15:15:12', '2014-10-19 15:15:12', '2014-10-19 15:15:12'),
                    (69, 0, 'CLASSIC', 0, 'catalog/CSR/16.jpg', 1, 1, '2015-05-19 15:18:51', '2015-05-19 15:18:51', '2015-05-19 15:18:51'),
                    (70, 0, 'CLASSIC', 0, 'catalog/CSR/15.jpg', 1, 1, '2014-10-19 15:23:19', '2014-10-19 15:23:19', '2014-10-19 15:23:19')
                ";
			$queries[] = "
                    INSERT INTO `" . DB_PREFIX . "CSR_article_description` (`article_id`, `language_id`, `title`, `description`, `content`, `tags`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
			...
			$queries[] = "
                    INSERT INTO `" . DB_PREFIX . "CSR_article_gallery` (`article_item_id`, `article_id`, `path`, `width`, `height`, `type`, `output`, `sort_order`) VALUES
                    (2746, 27, 'catalog/CSR/8.jpg', 1272, 720, 'IMG', '<img src=\"http://localhost:8888/OpenCart/fastor/2.0.3/image/cache/catalog/CSR/8-1272x720.jpg\" alt=\"media\" />', 1),
                    (2743, 20, 'catalog/CSR/14.jpg', 1200, 600, 'IMG', '<img src=\"http://localhost:8888/OpenCart/fastor/2.0.3/image/cache/catalog/CSR/14-1200x600.jpg\" alt=\"media\" />', 1),
                    (2738, 18, 'catalog/CSR/slider-1.jpg', 1200, 600, 'IMG', '<img src=\"http://localhost:8888/OpenCart/fastor/2.0.3/image/cache/catalog/CSR/slider-1-1200x600.jpg\" alt=\"media\" />', 2),
                    (2737, 18, 'catalog/CSR/slider-2.jpg', 1200, 600, 'IMG', '<img src=\"http://localhost:8888/OpenCart/fastor/2.0.3/image/cache/catalog/CSR/slider-2-1200x600.jpg\" alt=\"media\" />', 1),
                    (2741, 68, 'catalog/CSR/CSR-post-image.jpg', 1200, 908, 'IMG', '<img src=\"http://localhost:8888/OpenCart/fastor/2.0.3/image/cache/catalog/CSR/CSR-post-image-1200x908.jpg\" alt=\"media\" />', 1),
                    (2747, 69, 'catalog/CSR/8.jpg', 1272, 720, 'IMG', '<img src=\"http://localhost:8888/OpenCart/fastor/2.0.3/image/cache/catalog/CSR/8-1272x720.jpg\" alt=\"media\" />', 1),
                    ...
                    (2728, 66, 'catalog/CSR/10.jpg', 1200, 1009, 'IMG', '<img src=\"http://localhost:8888/OpenCart/fastor/2.0.3/image/cache/catalog/CSR/10-1200x1009.jpg\" alt=\"media\" />', 1),
                    (2729, 67, 'catalog/CSR/11.jpg', 1200, 1000, 'IMG', '<img src=\"http://localhost:8888/OpenCart/fastor/2.0.3/image/cache/catalog/CSR/11-1200x1000.jpg\" alt=\"media\" />', 1),
                    (2732, 70, 'catalog/CSR/14.jpg', 1200, 600, 'IMG', '<img src=\"http://localhost:8888/OpenCart/fastor/2.0.3/image/cache/catalog/CSR/14-1200x600.jpg\" alt=\"media\" />', 1),
                    (2742, 64, 'catalog/CSR/slider-1.jpg', 1200, 600, 'IMG', '<img src=\"http://localhost:8888/OpenCart/fastor/2.0.3/image/cache/catalog/CSR/slider-1-1200x600.jpg\" alt=\"media\" />', 1)
            ";
                
			$queries[] = "
                    INSERT INTO `" . DB_PREFIX . "CSR_article_related` (`article_id`, `related_id`) VALUES
                    (18, 20),
                    (27, 20),
                    (64, 20),
                    (18, 34),
                ...
                ";
                $queries[] = "
                     INSERT INTO `" . DB_PREFIX . "CSR_product_related` (`article_id`, `related_id`) VALUES
                     (27, 28),
                     (27, 30),
                     (27, 41),
                     (27, 47)
                 ";
			$queries[] = "
                    INSERT INTO `" . DB_PREFIX . "CSR_article_to_store` (`article_id`, `store_id`) VALUES
                    (18, 0),
                    (20, 0),
                    (25, 0),
                    (27, 0),
                ...
                ";
			$queries[] = "
                    INSERT INTO `" . DB_PREFIX . "CSR_article_to_category` (`article_id`, `category_id`) VALUES
                    (18, 31),
                    (20, 25),
                    (25, 30),
                    (25, 33),
			...
			$queries[] = "
                    INSERT INTO `" . DB_PREFIX . "CSR_category` (`category_id`, `image`, `parent_id`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES 
                ...
                ";
			$queries[] = "
                    INSERT INTO `" . DB_PREFIX . "CSR_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES 
			...
			$queries[] = "
                    INSERT INTO `" . DB_PREFIX . "CSR_category_path` (`category_id`, `path_id`, `level`) VALUES 
                    (25, 25, 0),
                    (28, 25, 0),
                    (28, 28, 1),
                    (30, 25, 0),
			...
			$queries[] = "
                    INSERT INTO `" . DB_PREFIX . "CSR_category_to_store` (`category_id`, `store_id`) VALUES 
                    (17, 0),
                    (18, 0),
                    (20, 0),
                    (24, 0),
            ...
            $queries[] = "
                    INSERT INTO `" . DB_PREFIX . "CSR_comment` (`comment_id`, `article_id`, `name`, `email`, `content`, `status`, `date_added`, `date_modified`) VALUES 
            ...
            if($query->row){
                ...
                $output["CSR_category_module"] = array (
                  1 => 
                  array (
                    'heading_title' => array(
                        1 => 'Categories'
                ...
                $this->model_setting_setting->editSetting( "CSR_category", $output );
                $output = array();
                
                $output["CSR_popular_module"] = array (
                  1 => 
                  array (
                    'heading_title' => array(
                        1 => 'Popular Posts'
                ...
                $this->model_setting_setting->editSetting( "CSR_popular", $output );
                $output = array();
                
                $output["CSR_tags_module"] = array (
                  1 => 
                  array (
                    'heading_title' => array(
                        1 => 'Popular Tags'
                ...
                $this->model_setting_setting->editSetting( "CSR_tags", $output );
