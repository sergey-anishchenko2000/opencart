<?php
class ModelCSRArticle extends Model {
    
	public function addArticle($data) {

		$this->db->query("INSERT INTO " . DB_PREFIX . "CSR_article
                SET
		...
		if (isset($data['image'])) {
			$this->db->query("UPDATE " . DB_PREFIX . "CSR_article SET image = '" . $this->db->escape($data['image']) . "' WHERE article_id = '" . (int)$article_id . "'");
		}

		foreach ($data['article_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "CSR_article_description
                    SET
		...
		if (isset($data['article_category'])) {
			foreach ($data['article_category'] as $category_id) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "CSR_article_to_category SET article_id = '" . (int)$article_id . "', category_id = '" . (int)$category_id . "'");
			}
		}
		...
		if (isset($data['article_gallery'])) {
			foreach ($data['article_gallery'] as $article_gallery) {
				...
				$this->db->query("INSERT INTO " . DB_PREFIX . "CSR_article_gallery
        ...
        if (isset($data['product_related'])) {
			foreach ($data['product_related'] as $related_id) {
				$this->db->query("DELETE FROM " . DB_PREFIX . "CSR_product_related WHERE article_id = '" . (int)$article_id . "' AND related_id = '" . (int)$related_id . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "CSR_product_related SET article_id = '" . (int)$article_id . "', related_id = '" . (int)$related_id . "'");
			}
		}

        if (isset($data['article_related'])) {
			foreach ($data['article_related'] as $related_id) {
				$this->db->query("DELETE FROM " . DB_PREFIX . "CSR_article_related WHERE article_id = '" . (int)$article_id . "' AND related_id = '" . (int)$related_id . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "CSR_article_related SET article_id = '" . (int)$article_id . "', related_id = '" . (int)$related_id . "'");
			}
		}

		if (isset($data['article_store'])) {
			foreach ($data['article_store'] as $store_id) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "CSR_article_to_store SET article_id = '" . (int)$article_id . "', store_id = '" . (int)$store_id . "'");
			}
		}   
	...
	public function editArticle($article_id, $data) {
        ...
        $this->db->query("UPDATE " . DB_PREFIX . "CSR_article
               SET
                author_id = '" . (int)$data['author_id'] . "',
                article_list_gallery_display = '" . $data['article_list_gallery_display'] . "',
                sort_order = '" . (int)$data['sort_order'] . "',
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "CSR_article_description WHERE article_id = '" . (int)$article_id . "'");
        ...
        $this->db->query("DELETE FROM " . DB_PREFIX . "CSR_article_to_category WHERE article_id = '" . (int)$article_id . "'");
        ...
        $this->db->query("DELETE FROM " . DB_PREFIX . "CSR_article_gallery WHERE article_id = '" . (int)$article_id . "'");
        ...
        $this->db->query("DELETE FROM " . DB_PREFIX . "CSR_product_related WHERE article_id = '" . (int)$article_id . "'");
        ...
        $this->db->query("DELETE FROM " . DB_PREFIX . "CSR_article_related WHERE article_id = '" . (int)$article_id . "'");
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "CSR_article_to_store WHERE article_id = '" . (int)$article_id . "'");
	...
	public function deleteArticle($article_id) {
	        try{
	            ...
	            $this->db->query("DELETE FROM " . DB_PREFIX . "CSR_article WHERE article_id = '" . (int)$article_id . "'");
	            $this->db->query("DELETE FROM " . DB_PREFIX . "CSR_article_description WHERE article_id = '" . (int)$article_id . "'");
	            $this->db->query("DELETE FROM " . DB_PREFIX . "CSR_article_to_category WHERE article = '" . (int)$article_id . "'");
	            $this->db->query("DELETE FROM " . DB_PREFIX . "CSR_product_related WHERE article_id = '" . (int)$article_id . "'");
	            $this->db->query("DELETE FROM " . DB_PREFIX . "CSR_product_related WHERE related_id = '" . (int)$article_id . "'");
	            $this->db->query("DELETE FROM " . DB_PREFIX . "CSR_article_related WHERE article_id = '" . (int)$article_id . "'");
	            $this->db->query("DELETE FROM " . DB_PREFIX . "CSR_article_related WHERE related_id = '" . (int)$article_id . "'");
	            $this->db->query("DELETE FROM " . DB_PREFIX . "CSR_article_gallery WHERE article_id = '" . (int)$article_id . "'");
	            $this->db->query("DELETE FROM " . DB_PREFIX . "CSR_comment WHERE article_id = '" . (int)$article_id . "'");
	...
	public function getArticle($article_id) {
		$query = $this->db->query("SELECT *
                FROM " . DB_PREFIX . "CSR_article ba   
                LEFT JOIN " . DB_PREFIX . "CSR_article_description bad ON (ba.article_id = bad.article_id)
	...
	public function getArticleCategories($article_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "CSR_article_to_category WHERE article_id = '" . (int)$article_id . "'");
    ...
    public function getProductRelated($article_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "CSR_product_related WHERE article_id = '" . (int)$article_id . "'");
    ...
    public function getArticleRelated($article_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "CSR_article_related WHERE article_id = '" . (int)$article_id . "'");
	...
	public function getArticleGalleries($article_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "CSR_article_gallery
	...
	public function getArticles($data = array()) {
		$sql = "SELECT ba.*, bad.*, a.name as author FROM " . DB_PREFIX . "CSR_article ba
                LEFT JOIN " . DB_PREFIX . "CSR_article_description bad ON (ba.article_id = bad.article_id)
                LEFT JOIN " . DB_PREFIX . "CSR_author a ON (ba.author_id = a.author_id)
	...
	public function getArticleDescriptions($article_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "CSR_article_description WHERE article_id = '" . (int)$article_id . "'");
	...
	public function getArticleStores($article_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "CSR_article_to_store WHERE article_id = '" . (int)$article_id . "'");
	...
	public function getTotalArticles($data) {
		$sql = "SELECT COUNT(DISTINCT ba.article_id) AS total FROM " . DB_PREFIX . "CSR_article ba
                LEFT JOIN " . DB_PREFIX . "CSR_article_description bad ON (ba.article_id = bad.article_id)
                WHERE bad.language_id = '" . (int)$this->config->get('config_language_id') . "'";
